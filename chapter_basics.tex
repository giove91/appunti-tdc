...
\begin{definizione}
\label{def:problem}
 Dato un alfabeto $\Gamma$, chiamiamo \emph{problema} un insieme di stringhe finite
...
come a un \emph{problema}, intendendo con questo che consideriamo il corrispondente
