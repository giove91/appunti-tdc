...
\begin{definizione}
 ...
 \begin{itemize}
  ...
  con stato accettante. \mytodo{Questo è un chiaro errore di notazione.}
 \end{itemize}
\end{definizione}
...
\begin{definizione}
 ...
 che sarà denotata da una costante $s$. Se non c'è ambiguità al posto di $G_{M,w}$
...
\end{definizione}
 ...
 \mytodo{Ora se $t$ fosse una ben determinata configurazione, direi che
 la macchina accetta sse $\Ealt(s,t)$. Ma $t$ qui è un'insieme di configurazioni.}
