...
\begin{teorema}
 ...
 Supponendo in più che $L$ sia un linguaggio relazionale
 (senza ovvero simboli di funzioni), vale anche il viceversa, ovvero $A \equiv_k B$
 implica $A \EFeq_k B$.
\end{teorema}
\begin{proof}
 $\Rightarrow$) Procediamo per induzione su $k$. Per $k=0$ segue dall'osservazione
 precedente e dalle definizioni.
\end{proof}
